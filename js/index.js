let baseLink = "http://martanetza.com/kea/cms/Dyczkowski/wordpress/wp-json/wp/v2/"
let PaintingCatLink = "http://martanetza.com/kea/cms/Dyczkowski/wordpress/wp-json/wp/v2/paintings";
let PhotoCatLink = "http://martanetza.com/kea/cms/Dyczkowski/wordpress/wp-json/wp/v2/photo";
...
fetch(PhotoCatLink).then(promise => promise.json()).then(data => buildPhotoCategories(data));
